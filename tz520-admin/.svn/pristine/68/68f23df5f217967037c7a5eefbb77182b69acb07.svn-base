...
<div class="form form-horizontal" id="form-admin-add">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>城市名：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="cityName" name="cityName">
			<input type="hidden" class="input-text" value="" placeholder="" id="oldCityName" name="oldCityName">
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript" src="${request.contextPath}/static/js/city/update.js"></script> 
<!--请在下方写此页面业务相关的脚本-->
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>