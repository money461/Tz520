	   ...
	   <div class="row cl">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容分类：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select id="contentCategoryId" name="contentCategoryId" class="select">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容大标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="contentTitle" name="contentTitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容小标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="暂时可不写" id="subTitle" name="subTitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="暂时可不写" id="titleDesc" name="titleDesc">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>超链接url：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="广告超链接" id="url" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">内容描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="contentDesc" name="contentDesc" cols="" rows="" class="textarea"  placeholder="对该商品写个推销语吧" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">重新上传广告图片1：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button  class="btn btn-primary radius submit_data" type="button"><i class="Hui-iconfont">&#xe632;</i>更新保存</button>
...
<script type="text/javascript" src="${request.contextPath}/static/js/content/update.js"></script> 
