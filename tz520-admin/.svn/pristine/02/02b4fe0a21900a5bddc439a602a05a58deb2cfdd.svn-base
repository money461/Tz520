...
<body>
<nav class="breadcrumb"> 爱心值消费明细<span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="userName" id="userName" placeholder="会员名称" style="width:180px" class="input-text">
		<button name="" id="" class="btn btn-success search_btn" type="submit"><i class="Hui-iconfont">&#xe665;</i> 检索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	  <div class="l" >消费类型：
			<select id="selectType" style="width:100px" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="select">
			...
			<span class="r">共有数据：<strong class="data_count"></strong> 条</span> </div>
			<div><a class="btn btn-primary radius" onclick="ExportExcel('导出爱心值明细数据','/tz/admin/userLoveDetails/alterUserLoveDetailsPage?type=exportExcel')" href="javascript:;"><i class="Hui-iconfont">&#xe640;</i> 导出爱心值明细数据</a></div>
		<div class="mt-20">
...
<script type="text/javascript" src="${request.contextPath}/static/js/userLoveDetails/list.js"></script>
