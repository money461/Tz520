...
<body>
<nav class="breadcrumb"> 团队管理 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="user_add('新增代理','/tz/admin/userCity/addPage?type=team&userId=<#if userId??>${userId }</#if>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>新增代理</a></span> <span class="r">共有数据：<strong class="data_count"></strong> 条</span> </div>
	<div class="mt-20">
...
<script type="text/javascript" src="${request.contextPath}/static/js/team/list.js"></script>
</body>
</html>