...
<div class="page-container">
	...
	<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	    <a class="btn btn-primary radius" onclick="item_add('添加商品','/tz/admin/tzItem/addOrUpdatePage?type=add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a></span>
	 <span class="r">共有数据：<strong class="data_count"></strong>条</span>
	 <span class="r">商品总件数 : <strong style="color:red" class="userTotal">0 </strong>条&nbsp;&nbsp;</span>
	 </div>
