...
<div class="form form-horizontal" id="form-dictionary-add">
  <input type="hidden" name="id" id="id" value="${id}"/>
	...
	<div class="row cl">
   	...
   	<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">重新上传分类标识图：</label>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${request.contextPath}/static/js/contentCategory/update.js"></script> 
<!--请在下方写此页面业务相关的脚本-->
</body>
</html>