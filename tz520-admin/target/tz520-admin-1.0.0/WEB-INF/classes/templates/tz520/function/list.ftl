...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="realName" id="realName" placeholder="权限名称" style="width:250px" class="input-text">
		<input type="text" name="phone" id="phone" placeholder="关键字" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success search_btn" type="submit"><i class="Hui-iconfont">&#xe665;</i> 检索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="admin_function_add('添加权限','/tz/admin/function/addOrUpdatePage?type=add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r">共有数据：<strong class="data_count"></strong> 条</span><@shiro.hasPermission name="all"> <span class="r">推荐订单总数 : <strong style="color:red" class="tjtotal">0 </strong>单&nbsp;&nbsp;</span><span class="r">用户总数 : <strong style="color:red" class="userTotal">0 </strong>人&nbsp;&nbsp;</span></@shiro.hasPermission>  </div>
