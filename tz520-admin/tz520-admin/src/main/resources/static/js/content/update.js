$(function(){
	...
	$('.submit_data').click(function(){
		...
		layer.confirm('确认数据检查无误并提交?',function(index){
			$.ajax({
		        type: "POST",
		        url: '/tz/admin/tzContent/updateContent',
		        data: {id:id,contentTitle:contentTitle,contentCategoryId:contentCategoryId,subTitle:subTitle,
	...
	$.ajax({
        ...
        success: function(data){
            ...
            if(data.flag){
	    		...
	    		//广告分类
	    		$("#contentCategoryId option[value='"+data.contentCategoryId+"']").prop('selected',true);
