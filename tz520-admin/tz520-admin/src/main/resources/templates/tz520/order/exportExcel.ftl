...
<article class="page-container">
  <form id="formData" action="/tz/admin/order/importExel" method="post">
    <input type="hidden" name="startTime" id="startTime" value="" >
    <input type="hidden" name="endTime" id="endTime" value="" >
    <input type="hidden" name="id" id="id" value="" >
    <input type="hidden" name="userPhone" id="userPhone" value="" >
    <input type="hidden" name="consignName" id="consignName" value="" >
...
<script type="text/javascript" src="${request.contextPath}/static/js/order/exportExcel.js"></script> 
