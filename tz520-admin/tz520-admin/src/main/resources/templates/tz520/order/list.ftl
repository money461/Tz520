...
<div class="page-container">
	<div class="text-c">
		<button onclick="removeIframe()" class="btn btn-primary radius">关闭选项卡</button>
		 日期范围：
		<input type="text" onfocus="WdatePicker({skin:'whyGreen',minDate:'2017-01-01',maxDate:''})" id="startTime" class="input-text Wdate" style="width:80px;">
		-
		<input type="text" onfocus="WdatePicker({skin:'whyGreen',minDate:'2017-01-01',maxDate:''})" id="endTime" class="input-text Wdate" style="width:80px;">
		<input type="text" name="" id="orderId" placeholder="订单编号" style="width:190px" class="input-text">
		<input type="text" name="" id="userPhone" placeholder="用户电话" style="width:150px" class="input-text">
		<input type="text" name="" id="consignName" placeholder="收货人" style="width:100px" class="input-text">
		<span style="width:150px;">
			 <select class="btn btn-primary radius"  id="orderStatus" size="1">
				<option value="">所有订单</option>
				<option value="2">已付款未发货订单</option>
				<option value="3">已付款已发货订单</option>
				<option value="4">已付款交易完成订单</option>
				<option value="1">未付款订单</option>
				<option value="5">交易关闭订单</option>
	 ...
	 <span><a class="btn btn-primary radius" onclick="ExportExcel('导出订单数据','/tz/admin/order/OrderAlterPage?type=exportExcel')" href="javascript:;"><i class="Hui-iconfont">&#xe640;</i> 导出当前条件下订单数据</a></span>
	 </@shiro.hasPermission>
	 <div class="r">
	 <ul>
	 <li>共有订单数 : <strong style="color:red" class="data_count"></strong>条&nbsp;&nbsp;</li>
	 <@shiro.hasPermission name="queryOrderInfo">
	 <li class="totalPayment"></li>
	 <li class="totalItemNum"></li>
	 </@shiro.hasPermission>
	 <ul>
	 </div>
	 </div>
	 <span class="l" id="batchSend"></span>
