...
<![endif]-->
<!--/meta 作为公共模版分离出去-->
<title>导出用户爱心值数据</title>
</head>
<body>
<article class="page-container">
   <form id="formData" action="/tz/admin/userLove/importExcel" method="post">
     <input type="hidden" name="startTime" id="startTime" value="">
     <input type="hidden" name="endTime" id="endTime" value="">
     <input type="hidden" name="phone" id="phone" value="">
     <input type="hidden" name="userName" id="userName" value="">
     <input type="hidden" name="status" id="selectType" value="">
	<div class="row cl">
...
<script type="text/javascript" src="${request.contextPath}/static/js/userLove/exportExcel.js"></script> 
