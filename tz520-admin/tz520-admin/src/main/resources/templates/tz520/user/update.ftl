...
<div class="form form-horizontal" id="form-admin-add">
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="hidden" class="input-text" value="" placeholder="" id="oldUserName" name="name">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="hidden" class="input-text" value="" placeholder="" id="oldPhone" name="oldPhone">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="type" type="radio" id="type-1" value="0"> 
			...
			<div class="radio-box">
				<input type="radio" id="type-3" name="type" value="2">
				<label for="sex-2">爱心会员</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="type-4" name="type" value="3">
				<label for="sex-2">爱心合伙人</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="type-5" name="type" value="4">
				<label for="sex-2">城市爱心合伙人</label>
			</div>
			<input type="hidden" id="userType">
			<input type="hidden" id="userMallId">
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript" src="${request.contextPath}/static/js/user/update.js"></script> 
<!--请在下方写此页面业务相关的脚本-->
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>