	...
	<div action="" method="post" class="form form-horizontal" id="form-item-update">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button class="btn btn-primary radius submit_data" type="submit"><i class="Hui-iconfont">&#xe632;</i>提交保存</button>
...
<script type="text/javascript" src="${request.contextPath}/static/js/content/picSecondUrl.js"></script> 
