...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="realName" id="realName" placeholder=" 用户姓名" style="width:250px" class="input-text">
	...
	<span class="l"><a class="btn btn-primary radius" onclick="manager_add('添加管理员','/tz/admin/manager/addOrUpdatePage?type=add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span>
	</@shiro.hasPermission>  
	<span class="r">共有数据：<strong class="data_count"></strong> 条</span>
	<span class="r">推荐订单总数 : <strong style="color:red" class="tjtotal">0 </strong>单&nbsp;&nbsp;</span>
	<span class="r">用户总数 : <strong style="color:red" class="userTotal">0 </strong>人&nbsp;&nbsp;</span>
	</div>
...
<script type="text/javascript" src="${request.contextPath}/static/js/manager/list.js"></script>  
</body>
</html>