...
<div class="page-container">
	<div action="" method="post" class="form form-horizontal" id="form-item-update">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			...
			<div class="radio-box">
				<input  type="radio" value="3" id="sex-2" name="status">
				<label for="sex-2">删除</label>
			</div>
		</div>
	</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="description" name="description" cols="" rows="" class="textarea"  placeholder="对该商品写个推销语吧" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空"></textarea>
	...
	-->
		...
		<div class="row cl">
		   <label class="form-label col-xs-4 col-sm-2">商品轮播图片详情：</label>
		   <div class="col-xs-8 col-sm-10 imagesUrl"></div>
		</div>
		
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">重新上传轮播图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
<script type="text/javascript" src="${request.contextPath}/static/js/tzItem/update.js"></script> 
