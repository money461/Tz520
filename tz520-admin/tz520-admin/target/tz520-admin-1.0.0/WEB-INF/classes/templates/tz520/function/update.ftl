...
<form class="form form-horizontal" id="form-admin-function">
  <input id="id" type="hidden" name="id" value=${id}>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>父功能节点：</label>
		<div class="formControls col-xs-8 col-sm-9"> 
		<span class="select-box" style="width:200px;">
			<select class="select valid" id="pId" name="pId" size="1">
			</select>
		</span> 
	  </div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea id="description" name="description" rows="4" cols="33"></textarea>
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript" src="${request.contextPath}/static/js/function/update.js"></script>  
