	...
	<div action="" method="post" class="form form-horizontal" id="form-item-add">
	   <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="contentDesc" name="contentDesc" cols="" rows="" class="textarea"  placeholder="内容描述" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">广告图片1：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
<script type="text/javascript" src="${request.contextPath}/static/js/content/add.js"></script> 
