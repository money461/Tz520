 ...
 getList:function(curPage,rows) {
    ...
    $.ajax({
        ...
        data: {"rows":rows, "curPage":curPage,startTime:startTime,endTime:endTime,
        	refereeName:refereeName,userPhone:userPhone,refereeId:refereeId,selectType:selectType,selectType2:selectType2},
        ...
        success: function (data) {
	        ...
	        $(".LoveSurplus").text(data.data.navigateFirstPage);
	        $(".LoveTotal").text(data.data.navigateLastPage);
