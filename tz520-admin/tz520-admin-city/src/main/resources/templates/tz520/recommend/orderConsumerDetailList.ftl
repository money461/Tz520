...
<body>
<nav class="breadcrumb"> 推荐会员消费记录订单详情<span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
		...
		<input type="hidden" class="orderId" value="<#if orderId??>${orderId }</#if>"> 
	</div>
</div>
<!--_footer 作为公共模版分离出去-->
...
<script type="text/javascript" src="${request.contextPath}/static/js/recommend/orderConsumerDetailList.js"></script>
