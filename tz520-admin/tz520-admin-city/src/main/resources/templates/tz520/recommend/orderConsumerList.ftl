...
<body>
<nav class="breadcrumb"> 推荐会员消费记录 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="userNick" id="userNick" placeholder="推荐会员昵称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success search_btn" type="submit"><i class="Hui-iconfont">&#xe665;</i> 检索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">

			</span>
			<span class="r">共有数据：<strong class="data_count"></strong> 条</span> <span class="r">单品消费总金额: <strong style="color:red" class="total">0</strong>元 &nbsp;&nbsp;</span></div>
		<div class="mt-20">
...
<script type="text/javascript" src="${request.contextPath}/static/js/recommend/orderConsumerList.js"></script>
