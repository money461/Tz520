...
<div class="page-container">
	...
	<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span>
	 <@shiro.hasPermission name="addContent">
	   <span><a class="btn btn-primary radius" onclick="content_add('添加内容','/tz/admin/tzContent/contentAlterPage?type=add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加内容</a></span>
	  </@shiro.hasPermission>
