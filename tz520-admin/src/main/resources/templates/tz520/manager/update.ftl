...
<div class="form form-horizontal" id="form-admin-update">
   <input id="id" type="hidden" name="id" value=${id}>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="" placeholder="密码修改,不修改密码可以不填写" id="password" name="password">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="输入常用邮箱" name="email" id="email">
		</div>
	</div>
	<div class="row cl">
