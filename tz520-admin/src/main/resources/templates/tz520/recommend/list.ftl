...
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="refereePhone" id="refereePhone" placeholder="推荐会员电话" style="width:250px" class="input-text">
	...
	<div class="l" >处理状态：
			<span>
				<select id="selectType2" style="width:100px" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="select">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			<thead>
				<tr class="text-c">
					<th width="70">推荐会员名</th>
					<th width="70">推荐会员昵称</th>
