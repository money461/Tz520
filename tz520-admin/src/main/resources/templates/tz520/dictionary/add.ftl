...
<![endif]-->
<title>添加数据字典- 系统管理 - H-ui.admin v2.4</title>
	...
	<div class="row cl">
		...
		<span class="select-box">
		  <select class="select" size="1" name="type">
		    <option value="0" selected>权限类型</option>
		    <option value="1">角色类型</option>
		    <option value="2">城市类型</option>
		  </select>
		</span>
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称描述：</label>
		<div class="formControls col-xs-8 col-sm-9">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${request.contextPath}/static/js/dictionary/add.js"></script> 
<!--请在下方写此页面业务相关的脚本-->
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>