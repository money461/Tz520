...
<div class="form form-horizontal" id="form-admin-role">
   <input type="hidden" name="id" id="roleId" value="${id}" />
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2">修改角色上级目录：</label>
		<div class="formControls col-xs-8 col-sm-9"> 
		<ul id="roleDemo" class="ztree"></ul>
	  </div>
	</div>
	<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">重新授予(单个或者多个)权限：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
...
<script type="text/javascript" src="${request.contextPath}/static/js/role/update.js"></script>
