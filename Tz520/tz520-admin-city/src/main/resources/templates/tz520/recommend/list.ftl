...
<body>
<nav class="breadcrumb"> 推荐会员管理 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		...
		<input type="text" name="refereeName" id="refereeName" placeholder="推荐会员昵称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success search_btn" type="submit"><i class="Hui-iconfont">&#xe665;</i> 检索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
			<select id="selectType" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="select">
			<option value="">全部</option>
			<option value="1">直推</option>
			<option value="2">下级推荐</option>
			<option value="3">关联推荐</option>
			</select>
			</span>
			<span class="l">
				<select id="selectType2" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="select">
				<option value="">全部</option>
				<option value="0">未处理</option>
				<option value="1">已处理</option>
				</select>
			</span>
			<span class="r">共有数据：<strong class="data_count"></strong> 条</span> <span class="r">剩余爱心值：<strong style="color:blue" class="LoveSurplus"></strong> 个&nbsp;&nbsp;</span><span class="r">总爱心值：<strong style="color:red" class="LoveTotal"></strong>个 &nbsp;&nbsp;</span></div>
		<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			<thead>
				<tr class="text-c">
					<!--<th width="40">推荐会员名</th>
					<th width="70">推荐会员电话</th>
					<th width="50">推荐会员付款方式</th>
					<th width="70">推荐会员付款账号</th> -->
					<th width="70">被推荐会员昵称</th>
					<th width="70">被推荐会员电话</th>
					<th width="70">被推荐付款方式</th>
					<th width="70">被推荐付款账号</th>
...
<script type="text/javascript" src="${request.contextPath}/static/js/recommend/list.js"></script>
